...
// GetTaxRedirectRate returns the fraction of the full burn tax that is redirected to the
// market accumulator before any other split (burn, community pool, oracle) is applied
