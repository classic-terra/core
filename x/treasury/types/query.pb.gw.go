...
var (
	...
	pattern_Query_Whitelist_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"terra", "treasury", "v1beta1", "whitelist"}, "", runtime.AssumeColonVerbOpt(false)))
