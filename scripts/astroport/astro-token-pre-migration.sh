...
CONTRACTPATH="scripts/astroport/old_contracts/astroport_token.wasm"
...
PRE_TOKEN_UPGRADE_CONTRACT_ADDR=$($BINARY q tx $txhash -o json | jq -r '.raw_log' | jq -r '.[0].events[0].attributes[3].value')
export PRE_TOKEN_UPGRADE_CONTRACT_ADDR
