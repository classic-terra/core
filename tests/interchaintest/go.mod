...
require (
	...
	github.com/cosmos/ibc-go/v7 v6.2.0
...
require (
	...
	github.com/cometbft/cometbft v0.34.29 // indirect
...
replace (
	...
	github.com/cometbft/cometbft => github.com/classic-terra/cometbft v0.34.29-terra.0
)
