...
# sed -i -E 's|127.0.0.1:9091|127.0.0.1:9089|g' $VALIDATOR2_APP_TOML
...
# sed -i -E 's|127.0.0.1:9091|127.0.0.1:9087|g' $VALIDATOR3_APP_TOML
...
# update_test_genesis '.app_state["consensus_params"]["block"]["max_gas"] = "100000000"'
...
terrad q bank balances $(terrad keys show validator1 -a --keyring-backend=test --home=$HOME/.terrad/validator1)

# terrad tx bank send $(terrad keys show validator1 -a --keyring-backend=test --home=$HOME/.terrad/validator1) $(terrad keys show validator2 -a --keyring-backend=test --home=$HOME/.terrad/validator2) 9999999999999800000000000000000uluna --home=$HOME/.terrad/validator1 --keyring-backend=test -y --gas auto --gas-adjustment 3 --gas-prices 10uluna
