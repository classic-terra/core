...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"terra", "classictax", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_TaxRate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"terra", "classictax", "v1beta1", "taxrate"}, "", runtime.AssumeColonVerbOpt(false)))
)
