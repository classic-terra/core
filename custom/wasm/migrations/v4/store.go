...
// This migration handles the FIELD ORDER SWAP between wasmd v0.61.4 and v0.61.5.
//
// BACKGROUND:
...
//
// MIGRATION STRATEGY:
// 1. Read each ContractInfo using LegacyContractInfo (v0.61.4 schema)
// 2. Convert to new ContractInfo (v0.61.5 schema) with fields swapped
