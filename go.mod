...
require (
	github.com/CosmWasm/wasmd v0.30.0 //upgrade to v0.32.0
	github.com/CosmWasm/wasmvm v1.1.2
	github.com/cosmos/cosmos-sdk v0.45.16 //upgrade to v0.45.16
	github.com/cosmos/gogoproto v1.4.4 //upgrade to v1.4.10
	github.com/cosmos/ibc-go/v4 v4.3.1 //upgrade to v4.4.2
	...
	github.com/tendermint/tendermint v0.34.24 //upgrade to v0.34.28
