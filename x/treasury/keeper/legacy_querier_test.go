...
func getQueriedTaxRate(t *testing.T, ctx sdk.Context, cdc *codec.LegacyAmino, querier sdk.Querier, _ int64) sdk.Dec { //nolint:unparam
...
func getQueriedRewardWeight(t *testing.T, ctx sdk.Context, cdc *codec.LegacyAmino, querier sdk.Querier, _ int64) sdk.Dec { //nolint:unparam
	query := abci.RequestQuery{
...
func getQueriedTaxProceeds(t *testing.T, ctx sdk.Context, cdc *codec.LegacyAmino, querier sdk.Querier, _ int64) sdk.Coins { //nolint:unparam
	query := abci.RequestQuery{
...
func getQueriedSeigniorageProceeds(t *testing.T, ctx sdk.Context, cdc *codec.LegacyAmino, querier sdk.Querier, _ int64) sdk.Int { //nolint:unparam
	query := abci.RequestQuery{
